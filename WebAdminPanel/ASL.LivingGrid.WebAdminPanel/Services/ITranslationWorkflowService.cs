...
{
    Task<TranslationRequest> SubmitRequestAsync(string key, string culture, string proposedValue, string requestedBy, TranslationRequestStatus status = TranslationRequestStatus.PendingReview);
